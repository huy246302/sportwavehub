import { FaSync, FaStar, FaMobileAlt, FaShieldAlt } from 'react-icons/fa';
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="bg-white p-8 rounded-lg shadow-lg hover:shadow-2xl transition-shadow duration-300 text-center">
            ...
            <p className="text-gray-600 mb-4">Your data is safe with our top-notch security measures.</p>
          </div>
        </div>
      </div>
    </section>
